...
function Home() {
  ...
  return (
    <div className={`relative overflow-x-hidden ${isFullscreen ? "h-screen overflow-hidden flex flex-col" : "min-h-screen"}`}>
      ...
      {/* Wheel + controls */}
      <section className={`relative z-10 mx-auto grid max-w-[1800px] grid-cols-1 px-4 md:px-8 ${isFullscreen ? "lg:grid-cols-[1fr_320px] mt-1 gap-8 pb-2 flex-1 min-h-0" : "lg:grid-cols-[1fr_360px] mt-8 gap-8 pb-16"}`}>
